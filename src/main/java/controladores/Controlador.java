...
public class Controlador {
	...
	public void alquilarUnidad(int idreclamo, String piso, String numero, String documento) throws UnidadException, PersonaException{
		Unidad unidad = buscarUnidad(idreclamo, piso, numero);
		Persona persona = buscarPersona(documento);
	...
	public Integer agregarReclamo(Integer idreclamo, String piso, String numero, String documento, String ubicacion, String descripcion) throws EdificioException, UnidadException, PersonaException {
		Edificio edificio = buscarEdificio(idreclamo);
		Unidad unidad = buscarUnidad(idreclamo, piso, numero);
		Persona persona = buscarPersona(documento);
